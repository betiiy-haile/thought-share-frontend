  ...
  return (
    <div className=" px-5 lg:px-16 xl:px-28  flex flex-row gap-12 items-center justify-center">
      <div className="hidden lg:flex">
        <Image src="/sign-up.png" alt="sign up image" width={750} height={600} />
      </div>
      <div className="flex-1">
        <h2 className="text-3xl font-bold text-slate-300 w-[80%] mx-auto mb-4">Sign Up</h2>
        <form className="flex flex-col  gap-4 lg:gap-8 w-[80%] mx-auto">
            <div className="flex flex-col gap-2">
            <label htmlFor="name" className="text-slate-300 ">
                Name
              </label>
              <input type="text"placeholder="John Doe" className="w-full border-b outline-none font-light bg-transparent border-slate-500/30 focus:border-purple-600 text-slate-400 py-2 placeholder:font-light text-sm" />
            </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="relative">
              <input type={showConfirmPassword ? "text" : "password"} placeholder="" className="w-full font-light  border-b outline-none  bg-transparent border-slate-500/30 focus:border-purple-600 text-slate-400 py-2  text-sm" />

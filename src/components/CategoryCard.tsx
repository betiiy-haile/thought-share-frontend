...
const CategoryCard = ({ name, color, image }: Prop) => {
    ...
    return (
        <div className={`w-[170px] lg:w-[200px] xl:w-[250px] 2xl:w-[300px] h-[50px] xl:h-[90px] py-8 px-4 xl:px-6  flex items-center ${color} bg-opacity-20 gap-4 justify-center rounded-lg`}>
